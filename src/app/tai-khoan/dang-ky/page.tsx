      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl transition-all duration-300 hover:shadow-lg">
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <AddressSelector form={form.address} setForm={setAddressWrapper} />
      ...
      >
        <div className="p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Mã OTP đã được gửi đến {useEmail ? form.email : form.phone}. Vui
              lòng nhập mã 6 chữ số để hoàn tất đăng ký.
            </p>
          </div>
