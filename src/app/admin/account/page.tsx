...
const AccountManagementPage: React.FC = () => {
      ...
      if (doctor) {
        setDoctorForm({
          userId: {
            ...
            dateOfBirth: typeof doctor.userId.dateOfBirth === 'string' 
              ? doctor.userId.dateOfBirth 
              : doctor.userId.dateOfBirth.toISOString().split('T')[0],
  ...
  const filteredPatients = patients.filter(patient =>
    patient.userId.fullName.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <div className="account-management-container">
      ...
      <div className="search-and-create">
        <InputComponent
          ...
          placeholder={`Tìm theo tên, email hoặc ${activeTab === 'doctor' ? 'chuyên khoa' : 'tiền sử bệnh'}`}
          name="search"
      ...
      {(isCreating || editingId) && activeTab === 'doctor' && (
        <div className="account-form">
          <h2>{isCreating ? 'Thêm bác sĩ mới' : 'Chỉnh sửa thông tin'}</h2>
  ...
  <div className="form-section">
    ...
    <div className={`collapsible-content ${showCertificates ? 'certificate_expanded' : ''}`}>
  ...
  {/* Experience Section */}
    <div className="form-section">
            ...
            <div className={`collapsible-content ${showExperience ? 'experience_expanded' : ''}`}>
              <div className="content-wrapper">
                <div className="multi-input-container">
                  <InputComponent
              ...
              filteredDoctors.length > 0 ? (
                filteredDoctors.map(doctor => (
                  <tr key={doctor._id}>
                    ...
                    <td>
                      <span className={`status-badge ${doctor.userId.isActive ? 'active' : 'inactive'}`}>
                        {doctor.userId.isActive ? 'Hoạt động' : 'Không hoạt động'}
                      </span>
                    </td>
              ...
              filteredPatients.length > 0 ? (
                filteredPatients.map(patient => (
                  <tr key={patient._id}>
                    ...
                    <td>
                      <span className={`status-badge ${patient.userId.isActive ? 'active' : 'inactive'}`}>
                        {patient.userId.isActive ? 'Hoạt động' : 'Không hoạt động'}
                      </span>
                    </td>
                    <td className="actions">
                      <button 
