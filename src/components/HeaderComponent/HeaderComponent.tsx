          ...
          <div className="flex justify-between items-center">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-xs font-bold text-[#3D90D7]">
                  BỆNH VIỆN
                </span>
                <span className="text-lg font-extrabold text-[#5A3E36] leading-4">
                  Lục Lâm 2
                </span>
              </div>
            </Link>
